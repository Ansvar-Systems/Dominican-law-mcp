...
export function getAbout(db: InstanceType<typeof Database>, context: AboutContext) {
  ...
  return {
    name: 'Dominican Republic Law MCP',
    version: context.version,
    jurisdiction: 'DO',
    description: 'Dominican Republic Law MCP — legislation via Model Context Protocol',
    stats,
    data_sources: [
      {
        name: 'Consultoria Juridica del Poder Ejecutivo',
        url: 'http://consultoria.gov.do',
        authority: 'Consultoria Juridica del Poder Ejecutivo',
      },
    ],
    freshness: {
